...
driver.get('http://manhattanbni.com/chapterlist.php?chapterchapter_name=manhattan&chapterCity=&chapterArea=&chapterMeetingDay=&chapterMeetingTime=')
time.sleep(0.5)
